...
---
<!-- Adapted for Org Mode output: plan files use .org extension and Org headings/TODO keywords -->

# Implementation Plan Creation

create an implementation plan in `docs/plans/yyyymmdd-<task-name>.org` with interactive context gathering.
...
check `docs/plans/` for existing files, then create `docs/plans/yyyymmdd-<task-name>.org` (use current date):
...
*** TODO Task 1: Add password hashing utility
...
*** TODO Task 2: Add user registration endpoint
...
*** TODO Task 1: [specific name - what this task accomplishes]
...
*** TODO Task N-1: Verify acceptance criteria
...
*** TODO Task N: [Final] Update documentation
...
after creating the file, tell user: "created plan: `docs/plans/yyyymmdd-<task-name>.org`"
